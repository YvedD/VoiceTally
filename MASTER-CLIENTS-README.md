...
> **Icoonlegende:** `✅` = OK, `⏳` = pending, `❌` = rejected, <img src="app/src/main/images/wifi.png" width="20" alt="WIFI" style="vertical-align:middle;"> Wi-Fi = Wi‑Fi, <img src="app/src/main/images/QR.png" width="20" alt="WIFI" style="vertical-align:middle;"> = QR-code
