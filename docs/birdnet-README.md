...
**Want to contribute?** We welcome contributions from the community! ðŸŽ‰
...
- ðŸ“‹ [TL;DR Quick Start](CONTRIBUTING.md#tldr---quick-start-for-experienced-developers) - 5-minute setup
- ðŸ”§ [Automated Environment Setup](CONTRIBUTING.md#development-environment-setup) - `task setup-dev` handles everything
- ðŸ“– [Development Workflow](CONTRIBUTING.md#development-workflow) - Hot reload, git hooks, testing
- âš–ï¸ [License & Privacy](CONTRIBUTING.md#license-and-legal) - CC BY-NC-SA 4.0, privacy-by-design
- ðŸ’¬ [Discord Community](https://discord.gg/gcSCFGUtsd) - Get help and discuss features

All contributions must follow:

- âœ… Privacy-by-design principles
- âœ… Code quality standards (automated via git hooks)
- âœ… CC BY-NC-SA 4.0 license terms
...
- **Copyright**: Â© Cornell Lab of Ornithology
